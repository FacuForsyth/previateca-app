...
export default function BannerCarrito() {
    ...
    //b2cConfirmation = '\n\n\n 👍 Perfecto, Gracias por tu pedido. Lo confirmamos en un momento... \n\n ♨️ Pizza Linda ♨️' 
		//e.preventDefault();
    const text = `Cliente: ${cliente.nombre} 🛵Dirección: ${cliente.direccion} Método de pago: ${cliente.metodoPago} Abona con: ${cliente.abonaCon} Comentario: ${cliente.comentario} 🍕🥤Detalle del pedido: ${Pedido} Comentario: ${cliente.comentario} 💲*Total: ${Total} 👍Perfecto, Gracias por tu pedido. Lo confirmamos en un momento... \n\n ♨️ Previateca ♨️`;
